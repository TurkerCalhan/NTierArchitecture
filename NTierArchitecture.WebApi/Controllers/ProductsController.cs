...
namespace NTierArchitecture.WebApi.Controllers
{
	public sealed class ProductsController : ApiController
	{
		...
		[HttpPost]
		public async Task<IActionResult> Remove(RemoveProductByIdCommand request, CancellationToken cancellationToken)
		{
			await _mediator.Send(request, cancellationToken);
			return NoContent();
		}
		...
		[HttpPost]
		public async Task<IActionResult> GellAll(GetProductsQuery request, CancellationToken cancellationToken)
		{
