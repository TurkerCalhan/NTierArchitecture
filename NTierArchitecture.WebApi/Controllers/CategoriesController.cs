...
public sealed class CategoriesController : ApiController
{
	...
	[HttpPost]
	public async Task<IActionResult> Remove(RemoveCategoryByIdCommand request, CancellationToken cancellationToken)
	{
		await _mediator.Send(request, cancellationToken);
		return NoContent();
	}
	...
	[HttpPost]
	public async Task<IActionResult> GellAll(GetCategoriesQuery request, CancellationToken cancellationToken)
	{
